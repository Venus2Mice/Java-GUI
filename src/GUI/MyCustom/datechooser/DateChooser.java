...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new GUI.MyCustom.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new GUI.MyCustom.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new GUI.MyCustom.datechooser.Button();
        cmdPrevious = new GUI.MyCustom.datechooser.Button();
        slide = new GUI.MyCustom.datechooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/MyCustom/datechooser/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/MyCustom/datechooser/previous.png"))); // NOI18N
    ...
    private GUI.MyCustom.datechooser.Button cmdForward;
    private GUI.MyCustom.datechooser.Button cmdMonth;
    private GUI.MyCustom.datechooser.Button cmdPrevious;
    private GUI.MyCustom.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private GUI.MyCustom.datechooser.Slider slide;
