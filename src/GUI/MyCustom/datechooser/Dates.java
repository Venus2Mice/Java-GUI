package GUI.MyCustom.datechooser;
...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new GUI.MyCustom.datechooser.Button();
        cmdTu = new GUI.MyCustom.datechooser.Button();
        cmdWe = new GUI.MyCustom.datechooser.Button();
        cmdTh = new GUI.MyCustom.datechooser.Button();
        cmdFr = new GUI.MyCustom.datechooser.Button();
        cmdSa = new GUI.MyCustom.datechooser.Button();
        cmdSu = new GUI.MyCustom.datechooser.Button();
        cmd1 = new GUI.MyCustom.datechooser.Button();
        cmd2 = new GUI.MyCustom.datechooser.Button();
        cmd3 = new GUI.MyCustom.datechooser.Button();
        cmd4 = new GUI.MyCustom.datechooser.Button();
        cmd5 = new GUI.MyCustom.datechooser.Button();
        cmd6 = new GUI.MyCustom.datechooser.Button();
        cmd7 = new GUI.MyCustom.datechooser.Button();
        cmd8 = new GUI.MyCustom.datechooser.Button();
        cmd9 = new GUI.MyCustom.datechooser.Button();
        cmd10 = new GUI.MyCustom.datechooser.Button();
        cmd11 = new GUI.MyCustom.datechooser.Button();
        cmd12 = new GUI.MyCustom.datechooser.Button();
        cmd13 = new GUI.MyCustom.datechooser.Button();
        cmd14 = new GUI.MyCustom.datechooser.Button();
        cmd15 = new GUI.MyCustom.datechooser.Button();
        cmd16 = new GUI.MyCustom.datechooser.Button();
        cmd17 = new GUI.MyCustom.datechooser.Button();
        cmd18 = new GUI.MyCustom.datechooser.Button();
        cmd19 = new GUI.MyCustom.datechooser.Button();
        cmd20 = new GUI.MyCustom.datechooser.Button();
        cmd21 = new GUI.MyCustom.datechooser.Button();
        cmd22 = new GUI.MyCustom.datechooser.Button();
        cmd23 = new GUI.MyCustom.datechooser.Button();
        cmd24 = new GUI.MyCustom.datechooser.Button();
        cmd25 = new GUI.MyCustom.datechooser.Button();
        cmd26 = new GUI.MyCustom.datechooser.Button();
        cmd27 = new GUI.MyCustom.datechooser.Button();
        cmd28 = new GUI.MyCustom.datechooser.Button();
        cmd29 = new GUI.MyCustom.datechooser.Button();
        cmd30 = new GUI.MyCustom.datechooser.Button();
        cmd31 = new GUI.MyCustom.datechooser.Button();
        cmd32 = new GUI.MyCustom.datechooser.Button();
        cmd33 = new GUI.MyCustom.datechooser.Button();
        cmd34 = new GUI.MyCustom.datechooser.Button();
        cmd35 = new GUI.MyCustom.datechooser.Button();
        cmd36 = new GUI.MyCustom.datechooser.Button();
        cmd37 = new GUI.MyCustom.datechooser.Button();
        cmd38 = new GUI.MyCustom.datechooser.Button();
        cmd39 = new GUI.MyCustom.datechooser.Button();
        cmd40 = new GUI.MyCustom.datechooser.Button();
        cmd41 = new GUI.MyCustom.datechooser.Button();
        cmd42 = new GUI.MyCustom.datechooser.Button();
    ...
    private GUI.MyCustom.datechooser.Button cmd1;
    private GUI.MyCustom.datechooser.Button cmd10;
    private GUI.MyCustom.datechooser.Button cmd11;
    private GUI.MyCustom.datechooser.Button cmd12;
    private GUI.MyCustom.datechooser.Button cmd13;
    private GUI.MyCustom.datechooser.Button cmd14;
    private GUI.MyCustom.datechooser.Button cmd15;
    private GUI.MyCustom.datechooser.Button cmd16;
    private GUI.MyCustom.datechooser.Button cmd17;
    private GUI.MyCustom.datechooser.Button cmd18;
    private GUI.MyCustom.datechooser.Button cmd19;
    private GUI.MyCustom.datechooser.Button cmd2;
    private GUI.MyCustom.datechooser.Button cmd20;
    private GUI.MyCustom.datechooser.Button cmd21;
    private GUI.MyCustom.datechooser.Button cmd22;
    private GUI.MyCustom.datechooser.Button cmd23;
    private GUI.MyCustom.datechooser.Button cmd24;
    private GUI.MyCustom.datechooser.Button cmd25;
    private GUI.MyCustom.datechooser.Button cmd26;
    private GUI.MyCustom.datechooser.Button cmd27;
    private GUI.MyCustom.datechooser.Button cmd28;
    private GUI.MyCustom.datechooser.Button cmd29;
    private GUI.MyCustom.datechooser.Button cmd3;
    private GUI.MyCustom.datechooser.Button cmd30;
    private GUI.MyCustom.datechooser.Button cmd31;
    private GUI.MyCustom.datechooser.Button cmd32;
    private GUI.MyCustom.datechooser.Button cmd33;
    private GUI.MyCustom.datechooser.Button cmd34;
    private GUI.MyCustom.datechooser.Button cmd35;
    private GUI.MyCustom.datechooser.Button cmd36;
    private GUI.MyCustom.datechooser.Button cmd37;
    private GUI.MyCustom.datechooser.Button cmd38;
    private GUI.MyCustom.datechooser.Button cmd39;
    private GUI.MyCustom.datechooser.Button cmd4;
    private GUI.MyCustom.datechooser.Button cmd40;
    private GUI.MyCustom.datechooser.Button cmd41;
    private GUI.MyCustom.datechooser.Button cmd42;
    private GUI.MyCustom.datechooser.Button cmd5;
    private GUI.MyCustom.datechooser.Button cmd6;
    private GUI.MyCustom.datechooser.Button cmd7;
    private GUI.MyCustom.datechooser.Button cmd8;
    private GUI.MyCustom.datechooser.Button cmd9;
    private GUI.MyCustom.datechooser.Button cmdFr;
    private GUI.MyCustom.datechooser.Button cmdMo;
    private GUI.MyCustom.datechooser.Button cmdSa;
    private GUI.MyCustom.datechooser.Button cmdSu;
    private GUI.MyCustom.datechooser.Button cmdTh;
    private GUI.MyCustom.datechooser.Button cmdTu;
    private GUI.MyCustom.datechooser.Button cmdWe;
