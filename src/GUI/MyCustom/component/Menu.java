package GUI.MyCustom.component;

import GUI.MyCustom.event.EventMenuSelected;
import GUI.MyCustom.model.Model_Menu;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("5", "Mượn trả", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        listMenu1 = new GUI.MyCustom.swing.ListMenu<>();

        panelMoving.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/MyCustom/icon/open-book.png"))); // NOI18N
    ...
    private GUI.MyCustom.swing.ListMenu<String> listMenu1;
